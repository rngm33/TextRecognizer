...
public class CameraSources {
    ...
    public static class Builder {
        ...
        private CameraSources cameraSource = new CameraSources();
    ...
    public CameraSources start() throws IOException {
        synchronized (cameraLock) {
            if (camera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public CameraSources start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (cameraLock) {
            if (camera != null) {
                return this;
            }
    ...
    private class PictureDoneCallback implements Camera.PictureCallback {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            synchronized (cameraLock) {
                if (CameraSources.this.camera != null) {
                    CameraSources.this.camera.startPreview();
                }
            }
        }
    }
